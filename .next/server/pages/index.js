...
const getStaticProps = async () => {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://nilooooyi:8vg5P7zFu22IlcL5@meetup.wkrlxt6.mongodb.net/?retryWrites=true&w=majority');
  const db = client.db();
